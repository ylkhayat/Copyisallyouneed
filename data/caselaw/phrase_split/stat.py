...
if __name__ == "__main__":
    ...
    data = []
    search_results_path = f'../{args["recall_method"]}_search_result_{args["chunk_length"]}_{args["worker_id"]}.txt'
    if args['dataset_path']:
        search_results_path = f"{args['dataset_path']}/{args['recall_method']}_search_result_{args['chunk_length']}_{args['worker_id']}.txt"
